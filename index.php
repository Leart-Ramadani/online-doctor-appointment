        ...
        <div class="container-fluid" style="background: #05204A;">
            ...
            <div class="loginBtn d-flex justify-content-center align-items-center">
                <?php if (!isset($_SESSION['fullName'])) { ?>
                    <a href="./patientSide/login.php">
                        <button type="button" class="login btn btn-outline-light me-2">
                            <i class="fa-solid fa-arrow-right-to-bracket pe-1"></i> Login
                        </button>
                    </a>
                <?php } else { ?>
                    <a href="./patientSide/logout.php">
                        <button type="button" class="btn btn-outline-warning me-2">
                            <i class="fa-solid fa-arrow-right-to-bracket pe-1"></i> Log out
                        </button>
                    </a>
                <?php } ?>
